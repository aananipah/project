            ...
            <section class="sidebar">
                ...
                @if (Auth::user()->level == 1)
                    ...
                    <ul class="sidebar-menu" data-widget="tree" >
                        ...
                        <li><a href="{{ route('viewPanduan') }}"><i class="fa fa-file-text"></i> Panduan</a></li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-database"></i> <span>Pelayanan Posyandu</span>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li>
                                    <a href="{{ route('viewPKK') }}"><i class="fa fa-circle-o"></i> PKK</a>
                                </li>
                                <li>
                                    <a href="{{ route('viewUKM') }}"><i class="fa fa-circle-o"></i> UKM</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        {{-- <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                {{-- <li><a href="{{ route('viewBGM') }}"><i class="fa fa-circle-o"></i> Data BGM dan 2T</a> --}}
                            {{-- </ul>
                        </li>  --}}
                        <li>
                        ...
                        <li>
                            <a href="{{ route('kehadiran.index') }}">
                                <i class="fa fa-balance-scale"></i> Data Kehadiran</a>
                        </li>
                        <li>
